    ...
    public mouseMovedHandler(mouse: MouseEvent) {
        ...
        if (this.decorator !== null) {
            if (this.decorator instanceof SVGRectElement) {
                moveRect(this.decorator as SVGRectElement,  ( this.cursorX - this.decorator.width.baseVal.value / 2).toString(), (this.cursorY - this.decorator.height.baseVal.value / 2).toString())
